...
#define VKDestroyInstance(...)                                                 \
  incontext->vkDestroyInstance(incontext->vkinstance, __VA_ARGS__)
...
#define VKEnumeratePhysicalDevices(...)                                        \
  incontext->vkEnumeratePhysicalDevices(incontext->vkinstance, __VA_ARGS__)
...
#define VKGetInstanceProcAddr(...)                                             \
  incontext->vkGetInstanceProcAddr(incontext->vkinstance, __VA_ARGS__)
...
#define VKEnumeratePhysicalDeviceGroups(...)                                   \
  incontext->vkEnumeratePhysicalDeviceGroups(incontext->vkinstance, __VA_ARGS__)
...
#define VKDestroySurfaceKHR(...)                                               \
  incontext->vkDestroySurfaceKHR(incontext->vkinstance, __VA_ARGS__)
...
#define VKCreateDisplayPlaneSurfaceKHR(...)                                    \
  incontext->vkCreateDisplayPlaneSurfaceKHR(incontext->vkinstance, __VA_ARGS__)
...
#define VKEnumeratePhysicalDeviceGroupsKHR(...)                                \
  incontext->vkEnumeratePhysicalDeviceGroupsKHR(incontext->vkinstance,         \
                                                __VA_ARGS__)
...
#define VKCreateDebugReportCallbackEXT(...)                                    \
  incontext->vkCreateDebugReportCallbackEXT(incontext->vkinstance, __VA_ARGS__)
...
#define VKDestroyDebugReportCallbackEXT(...)                                   \
  incontext->vkDestroyDebugReportCallbackEXT(incontext->vkinstance, __VA_ARGS__)
...
#define VKDebugReportMessageEXT(...)                                           \
  incontext->vkDebugReportMessageEXT(incontext->vkinstance, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL
...
#define VKCreateDebugUtilsMessengerEXT(...)                                    \
  incontext->vkCreateDebugUtilsMessengerEXT(incontext->vkinstance, __VA_ARGS__)
...
#define VKDestroyDebugUtilsMessengerEXT(...)                                   \
  incontext->vkDestroyDebugUtilsMessengerEXT(incontext->vkinstance, __VA_ARGS__)
...
#define VKSubmitDebugUtilsMessageEXT(...)                                      \
  incontext->vkSubmitDebugUtilsMessageEXT(incontext->vkinstance, __VA_ARGS__)
...
// VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface);
#define VKCreateHeadlessSurfaceEXT(...)                                        \
  incontext->vkCreateHeadlessSurfaceEXT(incontext->vkinstance, __VA_ARGS__)
...
#define VKCreateAndroidSurfaceKHR(...)                                         \
  incontext->vkCreateAndroidSurfaceKHR(incontext->vkinstance, __VA_ARGS__)
#endif
...
#define VKCreateImagePipeSurfaceFUCHSIA(...)                                   \
  incontext->vkCreateImagePipeSurfaceFUCHSIA(incontext->vkinstance, __VA_ARGS__)
#endif
...
#define VKCreateStreamDescriptorSurfaceGGP(...)                                \
  incontext->vkCreateStreamDescriptorSurfaceGGP(incontext->vkinstance,         \
                                                __VA_ARGS__)
#endif
...
#define VKCreateIOSSurfaceMVK(...)                                             \
  incontext->vkCreateIOSSurfaceMVK(incontext->vkinstance, __VA_ARGS__)
#endif
...
// pAllocator, VkSurfaceKHR* pSurface);
#define VKCreateMacOSSurfaceMVK(...)                                           \
  incontext->vkCreateMacOSSurfaceMVK(incontext->vkinstance, __VA_ARGS__)
#endif
...
// pAllocator, VkSurfaceKHR* pSurface);
#define VKCreateViSurfaceNN(...)                                               \
  incontext->vkCreateViSurfaceNN(incontext->vkinstance, __VA_ARGS__)
#endif
...
// VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface);
#define VKCreateWaylandSurfaceKHR(...)                                         \
  incontext->vkCreateWaylandSurfaceKHR(incontext->vkinstance, __VA_ARGS__)
...
#define VKCreateWin32SurfaceKHR(...)                                           \
  incontext->vkCreateWin32SurfaceKHR(incontext->vkinstance, __VA_ARGS__)
// VKAPI_ATTR VkBool32 VKAPI_CALL
...
#define VKCreateXcbSurfaceKHR(...)                                             \
  incontext->vkCreateXcbSurfaceKHR(incontext->vkinstance, __VA_ARGS__)
...
#define VKCreateXlibSurfaceKHR(...)                                            \
  incontext->vkCreateXlibSurfaceKHR(incontext->vkinstance, __VA_ARGS__)
...
// VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface);
#define VKCreateDirectFBSurfaceEXT(...)                                        \
  incontext->vkCreateDirectFBSurfaceEXT(incontext->vkinstance, __VA_ARGS__)
// VKAPI_ATTR VkBool32 VKAPI_CALL
...
#define VKCreateMetalSurfaceEXT(...)                                           \
  incontext->vkCreateMetalSurfaceEXT(incontext->vkinstance, __VA_ARGS__)
#endif
...
#define VKCreateScreenSurfaceQNX(...)                                          \
  incontext->vkCreateScreenSurfaceQNX(incontext->vkinstance, __VA_ARGS__)
// VKAPI_ATTR VkBool32 VKAPI_CALL
...
#define VKGetDeviceProcAddr(...)                                               \
  decontext->vkGetDeviceProcAddr(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkDestroyDevice( VkDevice device, const
// VkAllocationCallbacks* pAllocator);
#define VKDestroyDevice(...)                                                   \
  decontext->vkDestroyDevice(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDeviceQueue(...)                                                  \
  decontext->vkGetDeviceQueue(decontext->vkdevice, __VA_ARGS__)
...
#define VKDeviceWaitIdle() decontext->vkDeviceWaitIdle(decontext->vkdevice)
...
// void** ppData);
#define VKMapMemory(...)                                                       \
  decontext->vkMapMemory(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkUnmapMemory( VkDevice device, VkDeviceMemory
// memory);
#define VKUnmapMemory(...)                                                     \
  decontext->vkUnmapMemory(decontext->vkdevice, __VA_ARGS__)
...
#define VKFlushMappedMemoryRanges(...)                                         \
  decontext->vkFlushMappedMemoryRanges(decontext->vkdevice, __VA_ARGS__)
...
#define VKInvalidateMappedMemoryRanges(...)                                    \
  decontext->vkInvalidateMappedMemoryRanges(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDeviceMemoryCommitment(...)                                       \
  decontext->vkGetDeviceMemoryCommitment(decontext->vkdevice, __VA_ARGS__)
...
#define VKBindBufferMemory(...)                                                \
  decontext->vkBindBufferMemory(decontext->vkdevice, __VA_ARGS__)
...
#define VKBindImageMemory(...)                                                 \
  decontext->vkBindImageMemory(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetBufferMemoryRequirements(...)                                     \
  decontext->vkGetBufferMemoryRequirements(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetImageMemoryRequirements(...)                                      \
  decontext->vkGetImageMemoryRequirements(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetImageSparseMemoryRequirements(...)                                \
  decontext->vkGetImageSparseMemoryRequirements(decontext->vkdevice,           \
                                                __VA_ARGS__)
...
#define VKCreateFence(...)                                                     \
  decontext->vkCreateFence(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkDestroyFence( VkDevice device, VkFence fence,
// const VkAllocationCallbacks* pAllocator);
#define VKDestroyFence(...)                                                    \
  decontext->vkDestroyFence(decontext->vkdevice, __VA_ARGS__)
...
#define VKResetFences(...)                                                     \
  decontext->vkResetFences(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkGetFenceStatus( VkDevice device, VkFence
// fence);
#define VKGetFenceStatus(...)                                                  \
  decontext->vkGetFenceStatus(decontext->vkdevice, __VA_ARGS__)
...
#define VKWaitForFences(...)                                                   \
  decontext->vkWaitForFences(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateSemaphore(...)                                                 \
  decontext->vkCreateSemaphore(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroySemaphore(...)                                                \
  decontext->vkDestroySemaphore(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateEvent(...)                                                     \
  decontext->vkCreateEvent(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkDestroyEvent( VkDevice device, VkEvent event,
// const VkAllocationCallbacks* pAllocator);
#define VKDestroyEvent(...)                                                    \
  decontext->vkDestroyEvent(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkGetEventStatus( VkDevice device, VkEvent
// event);
#define VKGetEventStatus(...)                                                  \
  decontext->vkGetEventStatus(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkSetEvent( VkDevice device, VkEvent event);
#define VKSetEvent(...) decontext->vkSetEvent(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkResetEvent( VkDevice device, VkEvent event);
#define VKResetEvent(...)                                                      \
  decontext->vkResetEvent(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateQueryPool(...)                                                 \
  decontext->vkCreateQueryPool(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyQueryPool(...)                                                \
  decontext->vkDestroyQueryPool(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetQueryPoolResults(...)                                             \
  decontext->vkGetQueryPoolResults(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateBuffer(...)                                                    \
  decontext->vkCreateBuffer(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkDestroyBuffer( VkDevice device, VkBuffer buffer,
// const VkAllocationCallbacks* pAllocator);
#define VKDestroyBuffer(...)                                                   \
  decontext->vkDestroyBuffer(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateBufferView(...)                                                \
  decontext->vkCreateBufferView(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyBufferView(...)                                               \
  decontext->vkDestroyBufferView(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateImage(...)                                                     \
  decontext->vkCreateImage(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkDestroyImage( VkDevice device, VkImage image,
// const VkAllocationCallbacks* pAllocator);
#define VKDestroyImage(...)                                                    \
  decontext->vkDestroyImage(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetImageSubresourceLayout(...)                                       \
  decontext->vkGetImageSubresourceLayout(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateImageView(...)                                                 \
  decontext->vkCreateImageView(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyImageView(...)                                                \
  decontext->vkDestroyImageView(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateShaderModule(...)                                              \
  decontext->vkCreateShaderModule(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyShaderModule(...)                                             \
  decontext->vkDestroyShaderModule(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreatePipelineCache(...)                                             \
  decontext->vkCreatePipelineCache(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyPipelineCache(...)                                            \
  decontext->vkDestroyPipelineCache(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetPipelineCacheData(...)                                            \
  decontext->vkGetPipelineCacheData(decontext->vkdevice, __VA_ARGS__)
...
#define VKMergePipelineCaches(...)                                             \
  decontext->vkMergePipelineCaches(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateGraphicsPipelines(...)                                         \
  decontext->vkCreateGraphicsPipelines(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateComputePipelines(...)                                          \
  decontext->vkCreateComputePipelines(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyPipeline(...)                                                 \
  decontext->vkDestroyPipeline(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreatePipelineLayout(...)                                            \
  decontext->vkCreatePipelineLayout(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyPipelineLayout(...)                                           \
  decontext->vkDestroyPipelineLayout(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateSampler(...)                                                   \
  decontext->vkCreateSampler(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroySampler(...)                                                  \
  decontext->vkDestroySampler(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateDescriptorSetLayout(...)                                       \
  decontext->vkCreateDescriptorSetLayout(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyDescriptorSetLayout(...)                                      \
  decontext->vkDestroyDescriptorSetLayout(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateDescriptorPool(...)                                            \
  decontext->vkCreateDescriptorPool(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyDescriptorPool(...)                                           \
  decontext->vkDestroyDescriptorPool(decontext->vkdevice, __VA_ARGS__)
...
#define VKResetDescriptorPool(...)                                             \
  decontext->vkResetDescriptorPool(decontext->vkdevice, __VA_ARGS__)
...
#define VKAllocateDescriptorSets(...)                                          \
  decontext->vkAllocateDescriptorSets(decontext->vkdevice, __VA_ARGS__)
...
#define VKFreeDescriptorSets(...)                                              \
  decontext->vkFreeDescriptorSets(decontext->vkdevice, __VA_ARGS__)
...
#define VKUpdateDescriptorSets(...)                                            \
  decontext->vkUpdateDescriptorSets(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateFramebuffer(...)                                               \
  decontext->vkCreateFramebuffer(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyFramebuffer(...)                                              \
  decontext->vkDestroyFramebuffer(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateRenderPass(...)                                                \
  decontext->vkCreateRenderPass(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyRenderPass(...)                                               \
  decontext->vkDestroyRenderPass(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetRenderAreaGranularity(...)                                        \
  decontext->vkGetRenderAreaGranularity(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateCommandPool(...)                                               \
  decontext->vkCreateCommandPool(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyCommandPool(...)                                              \
  decontext->vkDestroyCommandPool(decontext->vkdevice, __VA_ARGS__)
...
#define VKResetCommandPool(...)                                                \
  decontext->vkResetCommandPool(decontext->vkdevice, __VA_ARGS__)
...
#define VKAllocateCommandBuffers(...)                                          \
  decontext->vkAllocateCommandBuffers(decontext->vkdevice, __VA_ARGS__)
...
#define VKFreeCommandBuffers(...)                                              \
  decontext->vkFreeCommandBuffers(decontext->vkdevice, __VA_ARGS__)
...
#define VKBindBufferMemory2(...)                                               \
  decontext->vkBindBufferMemory2(decontext->vkdevice, __VA_ARGS__)
...
#define VKBindImageMemory2(...)                                                \
  decontext->vkBindImageMemory2(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDeviceGroupPeerMemoryFeatures(...)                                \
  decontext->vkGetDeviceGroupPeerMemoryFeatures(decontext->vkdevice,           \
                                                __VA_ARGS__)
...
#define VKGetImageMemoryRequirements2(...)                                     \
  decontext->vkGetImageMemoryRequirements2(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetBufferMemoryRequirements2(...)                                    \
  decontext->vkGetBufferMemoryRequirements2(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetImageSparseMemoryRequirements2(...)                               \
  decontext->vkGetImageSparseMemoryRequirements2(decontext->vkdevice,          \
                                                 __VA_ARGS__)
...
#define VKTrimCommandPool(...)                                                 \
  decontext->vkTrimCommandPool(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDeviceQueue2(...)                                                 \
  decontext->vkGetDeviceQueue2(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateSamplerYcbcrConversion(...)                                    \
  decontext->vkCreateSamplerYcbcrConversion(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroySamplerYcbcrConversion(...)                                   \
  decontext->vkDestroySamplerYcbcrConversion(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateDescriptorUpdateTemplate(...)                                  \
  decontext->vkCreateDescriptorUpdateTemplate(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyDescriptorUpdateTemplate(...)                                 \
  decontext->vkDestroyDescriptorUpdateTemplate(decontext->vkdevice, __VA_ARGS__)
...
#define VKUpdateDescriptorSetWithTemplate(...)                                 \
  decontext->vkUpdateDescriptorSetWithTemplate(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDescriptorSetLayoutSupport(...)                                   \
  decontext->vkGetDescriptorSetLayoutSupport(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateRenderPass2(...)                                               \
  decontext->vkCreateRenderPass2(decontext->vkdevice, __VA_ARGS__)
...
#define VKResetQueryPool(...)                                                  \
  decontext->vkResetQueryPool(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreatePrivateDataSlot(...)                                           \
  decontext->vkCreatePrivateDataSlot(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyPrivateDataSlot(...)                                          \
  decontext->vkDestroyPrivateDataSlot(decontext->vkdevice, __VA_ARGS__)
...
#define VKSetPrivateData(...)                                                  \
  decontext->vkSetPrivateData(decontext->vkdevice, __VA_ARGS__)
...
// uint64_t* pData);
#define VKGetPrivateData(...)                                                  \
  decontext->vkGetPrivateData(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDeviceBufferMemoryRequirements(...)                               \
  decontext->vkGetDeviceBufferMemoryRequirements(decontext->vkdevice,          \
                                                 __VA_ARGS__)
...
#define VKGetDeviceImageMemoryRequirements(...)                                \
  decontext->vkGetDeviceImageMemoryRequirements(decontext->vkdevice,           \
                                                __VA_ARGS__)
...
#define VKGetDeviceImageSparseMemoryRequirements(...)                          \
  decontext->vkGetDeviceImageSparseMemoryRequirements(decontext->vkdevice,     \
                                                      __VA_ARGS__)
...
#define VKCreateSwapchainKHR(...)                                              \
  decontext->vkCreateSwapchainKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroySwapchainKHR(...)                                             \
  decontext->vkDestroySwapchainKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetSwapchainImagesKHR(...)                                           \
  decontext->vkGetSwapchainImagesKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKAcquireNextImageKHR(...)                                             \
  decontext->vkAcquireNextImageKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDeviceGroupPresentCapabilitiesKHR(...)                            \
  decontext->vkGetDeviceGroupPresentCapabilitiesKHR(decontext->vkdevice,       \
                                                    __VA_ARGS__)
...
#define VKGetDeviceGroupSurfacePresentModesKHR(...)                            \
  decontext->vkGetDeviceGroupSurfacePresentModesKHR(decontext->vkdevice,       \
                                                    __VA_ARGS__)
...
#define VKAcquireNextImage2KHR(...)                                            \
  decontext->vkAcquireNextImage2KHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateSharedSwapchainsKHR(...)                                       \
  decontext->vkCreateSharedSwapchainsKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateVideoSessionKHR(...)                                           \
  decontext->vkCreateVideoSessionKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyVideoSessionKHR(...)                                          \
  decontext->vkDestroyVideoSessionKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetVideoSessionMemoryRequirementsKHR(...)                            \
  decontext->vkGetVideoSessionMemoryRequirementsKHR(decontext->vkdevice,       \
                                                    __VA_ARGS__)
...
#define VKBindVideoSessionMemoryKHR(...)                                       \
  decontext->vkBindVideoSessionMemoryKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateVideoSessionParametersKHR(...)                                 \
  decontext->vkCreateVideoSessionParametersKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKUpdateVideoSessionParametersKHR(...)                                 \
  decontext->vkUpdateVideoSessionParametersKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkDestroyVideoSessionParametersKHR( VkDevice
// device, VkVideoSessionParametersKHR videoSessionParameters, const
// VkAllocationCallbacks* pAllocator);
#define VKDestroyVideoSessionParametersKHR(...)                                \
  decontext->vkDestroyVideoSessionParametersKHR(decontext->vkdevice,           \
                                                __VA_ARGS__)
...
#define VKGetDeviceGroupPeerMemoryFeaturesKHR(...)                             \
  decontext->vkGetDeviceGroupPeerMemoryFeaturesKHR(decontext->vkdevice,        \
                                                   __VA_ARGS__)
...
#define VKTrimCommandPoolKHR(...)                                              \
  decontext->vkTrimCommandPoolKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkGetMemoryFdKHR( VkDevice device, const
// VkMemoryGetFdInfoKHR* pGetFdInfo, int* pFd);
#define VKGetMemoryFdKHR(...)                                                  \
  decontext->vkGetMemoryFdKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetMemoryFdPropertiesKHR(...)                                        \
  decontext->vkGetMemoryFdPropertiesKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKImportSemaphoreFdKHR(...)                                            \
  decontext->vkImportSemaphoreFdKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetSemaphoreFdKHR(...)                                               \
  decontext->vkGetSemaphoreFdKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetSwapchainStatusKHR(...)                                           \
  decontext->vkGetSwapchainStatusKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkImportFenceFdKHR( VkDevice device, const
// VkImportFenceFdInfoKHR* pImportFenceFdInfo);
#define VKImportFenceFdKHR(...)                                                \
  decontext->vkImportFenceFdKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkGetFenceFdKHR( VkDevice device, const
// VkFenceGetFdInfoKHR* pGetFdInfo, int* pFd);
#define VKGetFenceFdKHR(...)                                                   \
  decontext->vkGetFenceFdKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkAcquireProfilingLockKHR( VkDevice device,
// const VkAcquireProfilingLockInfoKHR* pInfo);
#define VKAcquireProfilingLockKHR(...)                                         \
  decontext->vkAcquireProfilingLockKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkReleaseProfilingLockKHR( VkDevice device);
#define VKReleaseProfilingLockKHR()                                            \
  decontext->vkReleaseProfilingLockKHR(decontext->vkdevice)
// VKAPI_ATTR void VKAPI_CALL vkGetImageMemoryRequirements2KHR( VkDevice device,
// const VkImageMemoryRequirementsInfo2* pInfo, VkMemoryRequirements2*
// pMemoryRequirements);
#define VKGetImageMemoryRequirements2KHR(...)                                  \
  decontext->vkGetImageMemoryRequirements2KHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetBufferMemoryRequirements2KHR(...)                                 \
  decontext->vkGetBufferMemoryRequirements2KHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkGetImageSparseMemoryRequirements2KHR( VkDevice
// device, const VkImageSparseMemoryRequirementsInfo2* pInfo, uint32_t*
// pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2*
// pSparseMemoryRequirements);
#define VKGetImageSparseMemoryRequirements2KHR(...)                            \
  decontext->vkGetImageSparseMemoryRequirements2KHR(decontext->vkdevice,       \
                                                    __VA_ARGS__)
...
#define VKCreateSamplerYcbcrConversionKHR(...)                                 \
  decontext->vkCreateSamplerYcbcrConversionKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroySamplerYcbcrConversionKHR(...)                                \
  decontext->vkDestroySamplerYcbcrConversionKHR(decontext->vkdevice,           \
                                                __VA_ARGS__)
...
#define VKBindBufferMemory2KHR(...)                                            \
  decontext->vkBindBufferMemory2KHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKBindImageMemory2KHR(...)                                             \
  decontext->vkBindImageMemory2KHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDescriptorSetLayoutSupportKHR(...)                                \
  decontext->vkGetDescriptorSetLayoutSupportKHR(decontext->vkdevice,           \
                                                __VA_ARGS__)
...
#define VKGetSemaphoreCounterValueKHR(...)                                     \
  decontext->vkGetSemaphoreCounterValueKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkWaitSemaphoresKHR( VkDevice device, const
// VkSemaphoreWaitInfo* pWaitInfo, uint64_t timeout);
#define VKWaitSemaphoresKHR(...)                                               \
  decontext->vkWaitSemaphoresKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkSignalSemaphoreKHR( VkDevice device, const
// VkSemaphoreSignalInfo* pSignalInfo);
#define VKSignalSemaphoreKHR(...)                                              \
  decontext->vkSignalSemaphoreKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKWaitForPresentKHR(...)                                               \
  decontext->vkWaitForPresentKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkDeviceAddress VKAPI_CALL vkGetBufferDeviceAddressKHR( VkDevice
// device, const VkBufferDeviceAddressInfo* pInfo);
#define VKGetBufferDeviceAddressKHR(...)                                       \
  decontext->vkGetBufferDeviceAddressKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR uint64_t VKAPI_CALL vkGetBufferOpaqueCaptureAddressKHR( VkDevice
// device, const VkBufferDeviceAddressInfo* pInfo);
#define VKGetBufferOpaqueCaptureAddressKHR(...)                                \
  decontext->vkGetBufferOpaqueCaptureAddressKHR(decontext->vkdevice,           \
                                                __VA_ARGS__)
// VKAPI_ATTR uint64_t VKAPI_CALL vkGetDeviceMemoryOpaqueCaptureAddressKHR(
// VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo);
#define VKGetDeviceMemoryOpaqueCaptureAddressKHR(...)                          \
  decontext->vkGetDeviceMemoryOpaqueCaptureAddressKHR(decontext->vkdevice,     \
                                                      __VA_ARGS__)
...
// pDeferredOperation);
#define VKCreateDeferredOperationKHR(...)                                      \
  decontext->vkCreateDeferredOperationKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyDeferredOperationKHR(...)                                     \
  decontext->vkDestroyDeferredOperationKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR uint32_t VKAPI_CALL vkGetDeferredOperationMaxConcurrencyKHR(
// VkDevice device, VkDeferredOperationKHR operation);
#define VKGetDeferredOperationMaxConcurrencyKHR(...)                           \
  decontext->vkGetDeferredOperationMaxConcurrencyKHR(decontext->vkdevice,      \
                                                     __VA_ARGS__)
...
#define VKGetDeferredOperationResultKHR(...)                                   \
  decontext->vkGetDeferredOperationResultKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkDeferredOperationJoinKHR( VkDevice device,
// VkDeferredOperationKHR operation);
#define VKDeferredOperationJoinKHR(...)                                        \
  decontext->vkDeferredOperationJoinKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetPipelineExecutablePropertiesKHR(...)                              \
  decontext->vkGetPipelineExecutablePropertiesKHR(decontext->vkdevice,         \
                                                  __VA_ARGS__)
...
#define VKGetPipelineExecutableStatisticsKHR(...)                              \
  decontext->vkGetPipelineExecutableStatisticsKHR(decontext->vkdevice,         \
                                                  __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL
...
#define VKGetEncodedVideoSessionParametersKHR(...)                             \
  decontext->vkGetEncodedVideoSessionParametersKHR(decontext->vkdevice,        \
                                                   __VA_ARGS__)
...
#define VKGetDeviceBufferMemoryRequirementsKHR(...)                            \
  decontext->vkGetDeviceBufferMemoryRequirementsKHR(decontext->vkdevice,       \
                                                    __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkGetDeviceImageMemoryRequirementsKHR( VkDevice
// device, const VkDeviceImageMemoryRequirements* pInfo, VkMemoryRequirements2*
// pMemoryRequirements);
#define VKGetDeviceImageMemoryRequirementsKHR(...)                             \
  decontext->vkGetDeviceImageMemoryRequirementsKHR(decontext->vkdevice,        \
                                                   __VA_ARGS__)
...
#define VKGetDeviceImageSparseMemoryRequirementsKHR(...)                       \
  decontext->vkGetDeviceImageSparseMemoryRequirementsKHR(decontext->vkdevice,  \
                                                         __VA_ARGS__)
...
#define VKGetRenderingAreaGranularityKHR(...)                                  \
  decontext->vkGetRenderingAreaGranularityKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDeviceImageSubresourceLayoutKHR(...)                              \
  decontext->vkGetDeviceImageSubresourceLayoutKHR(decontext->vkdevice,         \
                                                  __VA_ARGS__)
...
#define VKGetImageSubresourceLayout2KHR(...)                                   \
  decontext->vkGetImageSubresourceLayout2KHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetCalibratedTimestampsKHR(...)                                      \
  decontext->vkGetCalibratedTimestampsKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKDebugMarkerSetObjectTagEXT(...)                                      \
  decontext->vkDebugMarkerSetObjectTagEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKDebugMarkerSetObjectNameEXT(...)                                     \
  decontext->vkDebugMarkerSetObjectNameEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateCuModuleNVX(...)                                               \
  decontext->vkCreateCuModuleNVX(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateCuFunctionNVX(...)                                             \
  decontext->vkCreateCuFunctionNVX(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyCuModuleNVX(...)                                              \
  decontext->vkDestroyCuModuleNVX(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyCuFunctionNVX(...)                                            \
  decontext->vkDestroyCuFunctionNVX(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetImageViewHandleNVX(...)                                           \
  decontext->vkGetImageViewHandleNVX(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetImageViewAddressNVX(...)                                          \
  decontext->vkGetImageViewAddressNVX(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetShaderInfoAMD(...)                                                \
  decontext->vkGetShaderInfoAMD(decontext->vkdevice, __VA_ARGS__)
...
#define VKDisplayPowerControlEXT(...)                                          \
  decontext->vkDisplayPowerControlEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKRegisterDeviceEventEXT(...)                                          \
  decontext->vkRegisterDeviceEventEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKRegisterDisplayEventEXT(...)                                         \
  decontext->vkRegisterDisplayEventEXT(decontext->vkdevice, __VA_ARGS__)
...
// pCounterValue);
#define VKGetSwapchainCounterEXT(...)                                          \
  decontext->vkGetSwapchainCounterEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetRefreshCycleDurationGOOGLE(...)                                   \
  decontext->vkGetRefreshCycleDurationGOOGLE(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetPastPresentationTimingGOOGLE(...)                                 \
  decontext->vkGetPastPresentationTimingGOOGLE(decontext->vkdevice, __VA_ARGS__)
...
// pMetadata);
#define VKSetHdrMetadataEXT(...)                                               \
  decontext->vkSetHdrMetadataEXT(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkSetDebugUtilsObjectNameEXT( VkDevice device,
// const VkDebugUtilsObjectNameInfoEXT* pNameInfo);
#define VKSetDebugUtilsObjectNameEXT(...)                                      \
  decontext->vkSetDebugUtilsObjectNameEXT(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkSetDebugUtilsObjectTagEXT( VkDevice device,
// const VkDebugUtilsObjectTagInfoEXT* pTagInfo);
#define VKSetDebugUtilsObjectTagEXT(...)                                       \
  decontext->vkSetDebugUtilsObjectTagEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetImageDrmFormatModifierPropertiesEXT(...)                          \
  decontext->vkGetImageDrmFormatModifierPropertiesEXT(decontext->vkdevice,     \
                                                      __VA_ARGS__)
...
#define VKCreateValidationCacheEXT(...)                                        \
  decontext->vkCreateValidationCacheEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyValidationCacheEXT(...)                                       \
  decontext->vkDestroyValidationCacheEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKMergeValidationCachesEXT(...)                                        \
  decontext->vkMergeValidationCachesEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetValidationCacheDataEXT(...)                                       \
  decontext->vkGetValidationCacheDataEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateAccelerationStructureNV(...)                                   \
  decontext->vkCreateAccelerationStructureNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyAccelerationStructureNV(...)                                  \
  decontext->vkDestroyAccelerationStructureNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKBindAccelerationStructureMemoryNV(...)                               \
  decontext->vkBindAccelerationStructureMemoryNV(decontext->vkdevice,          \
                                                 __VA_ARGS__)
...
// pAllocator, VkPipeline* pPipelines);
#define VKCreateRayTracingPipelinesNV(...)                                     \
  decontext->vkCreateRayTracingPipelinesNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetRayTracingShaderGroupHandlesKHR(...)                              \
  decontext->vkGetRayTracingShaderGroupHandlesKHR(decontext->vkdevice,         \
                                                  __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkGetRayTracingShaderGroupHandlesNV( VkDevice
// device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t
// dataSize, void* pData);
#define VKGetRayTracingShaderGroupHandlesNV(...)                               \
  decontext->vkGetRayTracingShaderGroupHandlesNV(decontext->vkdevice,          \
                                                 __VA_ARGS__)
...
#define VKGetAccelerationStructureHandleNV(...)                                \
  decontext->vkGetAccelerationStructureHandleNV(decontext->vkdevice,           \
                                                __VA_ARGS__)
...
#define VKCompileDeferredNV(...)                                               \
  decontext->vkCompileDeferredNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetMemoryHostPointerPropertiesEXT(...)                               \
  decontext->vkGetMemoryHostPointerPropertiesEXT(decontext->vkdevice,          \
                                                 __VA_ARGS__)
...
// uint32_t timestampCount, const VkCalibratedTimestampInfoKHR* pTimestampInfos,
// uint64_t* pTimestamps, uint64_t* pMaxDeviation);
#define VKGetCalibratedTimestampsEXT(...)                                      \
  decontext->vkGetCalibratedTimestampsEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKInitializePerformanceApiINTEL(...)                                   \
  decontext->vkInitializePerformanceApiINTEL(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkUninitializePerformanceApiINTEL( VkDevice
// device);
#define VKUninitializePerformanceApiINTEL()                                    \
  decontext->vkUninitializePerformanceApiINTEL(decontext->vkdevice)
...
#define VKAcquirePerformanceConfigurationINTEL(...)                            \
  decontext->vkAcquirePerformanceConfigurationINTEL(decontext->vkdevice,       \
                                                    __VA_ARGS__)
...
#define VKReleasePerformanceConfigurationINTEL(...)                            \
  decontext->vkReleasePerformanceConfigurationINTEL(decontext->vkdevice,       \
                                                    __VA_ARGS__)
...
// pValue);
#define VKGetPerformanceParameterINTEL(...)                                    \
  decontext->vkGetPerformanceParameterINTEL(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkSetLocalDimmingAMD( VkDevice device,
// VkSwapchainKHR swapChain, VkBool32 localDimmingEnable);
#define VKSetLocalDimmingAMD(...)                                              \
  decontext->vkSetLocalDimmingAMD(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkDeviceAddress VKAPI_CALL vkGetBufferDeviceAddressEXT( VkDevice
// device, const VkBufferDeviceAddressInfo* pInfo);
#define VKGetBufferDeviceAddressEXT(...)                                       \
  decontext->vkGetBufferDeviceAddressEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKResetQueryPoolEXT(...)                                               \
  decontext->vkResetQueryPoolEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKCopyMemoryToImageEXT(...)                                            \
  decontext->vkCopyMemoryToImageEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKCopyImageToMemoryEXT(...)                                            \
  decontext->vkCopyImageToMemoryEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKCopyImageToImageEXT(...)                                             \
  decontext->vkCopyImageToImageEXT(decontext->vkdevice, __VA_ARGS__)
...
// pTransitions);
#define VKTransitionImageLayoutEXT(...)                                        \
  decontext->vkTransitionImageLayoutEXT(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkGetImageSubresourceLayout2EXT( VkDevice device,
// VkImage image, const VkImageSubresource2KHR* pSubresource,
// VkSubresourceLayout2KHR* pLayout);
#define VKGetImageSubresourceLayout2EXT(...)                                   \
  decontext->vkGetImageSubresourceLayout2EXT(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkReleaseSwapchainImagesEXT( VkDevice device,
// const VkReleaseSwapchainImagesInfoEXT* pReleaseInfo);
#define VKReleaseSwapchainImagesEXT(...)                                       \
  decontext->vkReleaseSwapchainImagesEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetGeneratedCommandsMemoryRequirementsNV(...)                        \
  decontext->vkGetGeneratedCommandsMemoryRequirementsNV(decontext->vkdevice,   \
                                                        __VA_ARGS__)
...
#define VKCreateIndirectCommandsLayoutNV(...)                                  \
  decontext->vkCreateIndirectCommandsLayoutNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyIndirectCommandsLayoutNV(...)                                 \
  decontext->vkDestroyIndirectCommandsLayoutNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreatePrivateDataSlotEXT(...)                                        \
  decontext->vkCreatePrivateDataSlotEXT(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkDestroyPrivateDataSlotEXT( VkDevice device,
// VkPrivateDataSlot privateDataSlot, const VkAllocationCallbacks* pAllocator);
#define VKDestroyPrivateDataSlotEXT(...)                                       \
  decontext->vkDestroyPrivateDataSlotEXT(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkSetPrivateDataEXT( VkDevice device,
// VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot
// privateDataSlot, uint64_t data);
#define VKSetPrivateDataEXT(...)                                               \
  decontext->vkSetPrivateDataEXT(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkGetPrivateDataEXT( VkDevice device, VkObjectType
// objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot,
// uint64_t* pData);
#define VKGetPrivateDataEXT(...)                                               \
  decontext->vkGetPrivateDataEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateCudaModuleNV(...)                                              \
  decontext->vkCreateCudaModuleNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetCudaModuleCacheNV(...)                                            \
  decontext->vkGetCudaModuleCacheNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateCudaFunctionNV(...)                                            \
  decontext->vkCreateCudaFunctionNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyCudaModuleNV(...)                                             \
  decontext->vkDestroyCudaModuleNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyCudaFunctionNV(...)                                           \
  decontext->vkDestroyCudaFunctionNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDescriptorSetLayoutSizeEXT(...)                                   \
  decontext->vkGetDescriptorSetLayoutSizeEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDescriptorSetLayoutBindingOffsetEXT(...)                          \
  decontext->vkGetDescriptorSetLayoutBindingOffsetEXT(decontext->vkdevice,     \
                                                      __VA_ARGS__)
...
#define VKGetDescriptorEXT(...)                                                \
  decontext->vkGetDescriptorEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetBufferOpaqueCaptureDescriptorDataEXT(...)                         \
  decontext->vkGetBufferOpaqueCaptureDescriptorDataEXT(decontext->vkdevice,    \
                                                       __VA_ARGS__)
...
#define VKGetImageOpaqueCaptureDescriptorDataEXT(...)                          \
  decontext->vkGetImageOpaqueCaptureDescriptorDataEXT(decontext->vkdevice,     \
                                                      __VA_ARGS__)
...
#define VKGetImageViewOpaqueCaptureDescriptorDataEXT(...)                      \
  decontext->vkGetImageViewOpaqueCaptureDescriptorDataEXT(decontext->vkdevice, \
                                                          __VA_ARGS__)
...
#define VKGetSamplerOpaqueCaptureDescriptorDataEXT(...)                        \
  decontext->vkGetSamplerOpaqueCaptureDescriptorDataEXT(decontext->vkdevice,   \
                                                        __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL
...
#define VKGetDeviceFaultInfoEXT(...)                                           \
  decontext->vkGetDeviceFaultInfoEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetMemoryRemoteAddressNV(...)                                        \
  decontext->vkGetMemoryRemoteAddressNV(decontext->vkdevice, __VA_ARGS__)
...
// pPipelineProperties);
#define VKGetPipelinePropertiesEXT(...)                                        \
  decontext->vkGetPipelinePropertiesEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateMicromapEXT(...)                                               \
  decontext->vkCreateMicromapEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyMicromapEXT(...)                                              \
  decontext->vkDestroyMicromapEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKBuildMicromapsEXT(...)                                               \
  decontext->vkBuildMicromapsEXT(decontext->vkdevice, __VA_ARGS__)
...
// pInfo);
#define VKCopyMicromapEXT(...)                                                 \
  decontext->vkCopyMicromapEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKCopyMicromapToMemoryEXT(...)                                         \
  decontext->vkCopyMicromapToMemoryEXT(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkCopyMemoryToMicromapEXT( VkDevice device,
// VkDeferredOperationKHR deferredOperation, const
// VkCopyMemoryToMicromapInfoEXT* pInfo);
#define VKCopyMemoryToMicromapEXT(...)                                         \
  decontext->vkCopyMemoryToMicromapEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKWriteMicromapsPropertiesEXT(...)                                     \
  decontext->vkWriteMicromapsPropertiesEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDeviceMicromapCompatibilityEXT(...)                               \
  decontext->vkGetDeviceMicromapCompatibilityEXT(decontext->vkdevice,          \
                                                 __VA_ARGS__)
...
#define VKGetMicromapBuildSizesEXT(...)                                        \
  decontext->vkGetMicromapBuildSizesEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKSetDeviceMemoryPriorityEXT(...)                                      \
  decontext->vkSetDeviceMemoryPriorityEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetDescriptorSetLayoutHostMappingInfoVALVE(...)                      \
  decontext->vkGetDescriptorSetLayoutHostMappingInfoVALVE(decontext->vkdevice, \
                                                          __VA_ARGS__)
...
#define VKGetDescriptorSetHostMappingVALVE(...)                                \
  decontext->vkGetDescriptorSetHostMappingVALVE(decontext->vkdevice,           \
                                                __VA_ARGS__)
...
#define VKGetPipelineIndirectMemoryRequirementsNV(...)                         \
  decontext->vkGetPipelineIndirectMemoryRequirementsNV(decontext->vkdevice,    \
                                                       __VA_ARGS__)
...
#define VKGetPipelineIndirectDeviceAddressNV(...)                              \
  decontext->vkGetPipelineIndirectDeviceAddressNV(decontext->vkdevice,         \
                                                  __VA_ARGS__)
...
#define VKGetShaderModuleIdentifierEXT(...)                                    \
  decontext->vkGetShaderModuleIdentifierEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetShaderModuleCreateInfoIdentifierEXT(...)                          \
  decontext->vkGetShaderModuleCreateInfoIdentifierEXT(decontext->vkdevice,     \
                                                      __VA_ARGS__)
...
#define VKCreateOpticalFlowSessionNV(...)                                      \
  decontext->vkCreateOpticalFlowSessionNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyOpticalFlowSessionNV(...)                                     \
  decontext->vkDestroyOpticalFlowSessionNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKBindOpticalFlowSessionImageNV(...)                                   \
  decontext->vkBindOpticalFlowSessionImageNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateShadersEXT(...)                                                \
  decontext->vkCreateShadersEXT(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkDestroyShaderEXT( VkDevice device, VkShaderEXT
// shader, const VkAllocationCallbacks* pAllocator);
#define VKDestroyShaderEXT(...)                                                \
  decontext->vkDestroyShaderEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetShaderBinaryDataEXT(...)                                          \
  decontext->vkGetShaderBinaryDataEXT(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetFramebufferTilePropertiesQCOM(...)                                \
  decontext->vkGetFramebufferTilePropertiesQCOM(decontext->vkdevice,           \
                                                __VA_ARGS__)
...
#define VKGetDynamicRenderingTilePropertiesQCOM(...)                           \
  decontext->vkGetDynamicRenderingTilePropertiesQCOM(decontext->vkdevice,      \
                                                     __VA_ARGS__)
...
#define VKSetLatencySleepModeNV(...)                                           \
  decontext->vkSetLatencySleepModeNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKLatencySleepNV(...)                                                  \
  decontext->vkLatencySleepNV(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR void VKAPI_CALL vkSetLatencyMarkerNV( VkDevice device,
// VkSwapchainKHR swapchain, const VkSetLatencyMarkerInfoNV*
// pLatencyMarkerInfo);
#define VKSetLatencyMarkerNV(...)                                              \
  decontext->vkSetLatencyMarkerNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetLatencyTimingsNV(...)                                             \
  decontext->vkGetLatencyTimingsNV(decontext->vkdevice, __VA_ARGS__)
...
#define VKCreateAccelerationStructureKHR(...)                                  \
  decontext->vkCreateAccelerationStructureKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKDestroyAccelerationStructureKHR(...)                                 \
  decontext->vkDestroyAccelerationStructureKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKBuildAccelerationStructuresKHR(...)                                  \
  decontext->vkBuildAccelerationStructuresKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKCopyAccelerationStructureKHR(...)                                    \
  decontext->vkCopyAccelerationStructureKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKCopyAccelerationStructureToMemoryKHR(...)                            \
  decontext->vkCopyAccelerationStructureToMemoryKHR(decontext->vkdevice,       \
                                                    __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkCopyMemoryToAccelerationStructureKHR(
// VkDevice device, VkDeferredOperationKHR deferredOperation, const
// VkCopyMemoryToAccelerationStructureInfoKHR* pInfo);
#define VKCopyMemoryToAccelerationStructureKHR(...)                            \
  decontext->vkCopyMemoryToAccelerationStructureKHR(decontext->vkdevice,       \
                                                    __VA_ARGS__)
...
#define VKWriteAccelerationStructuresPropertiesKHR(...)                        \
  decontext->vkWriteAccelerationStructuresPropertiesKHR(decontext->vkdevice,   \
                                                        __VA_ARGS__)
...
#define VKGetAccelerationStructureDeviceAddressKHR(...)                        \
  decontext->vkGetAccelerationStructureDeviceAddressKHR(decontext->vkdevice,   \
                                                        __VA_ARGS__)
...
#define VKGetAccelerationStructureBuildSizesKHR(...)                           \
  decontext->vkGetAccelerationStructureBuildSizesKHR(decontext->vkdevice,      \
                                                     __VA_ARGS__)
...
// pAllocator, VkPipeline* pPipelines);
#define VKCreateRayTracingPipelinesKHR(...)                                    \
  decontext->vkCreateRayTracingPipelinesKHR(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL
...
#define VKGetRayTracingShaderGroupStackSizeKHR(...)                            \
  decontext->vkGetRayTracingShaderGroupStackSizeKHR(decontext->vkdevice,       \
                                                    __VA_ARGS__)
...
#define VKGetAndroidHardwareBufferPropertiesANDROID(...)                       \
  decontext->vkGetAndroidHardwareBufferPropertiesANDROID(decontext->vkdevice,  \
                                                         __VA_ARGS__)
...
#define VKGetMemoryAndroidHardwareBufferANDROID(...)                           \
  decontext->vkGetMemoryAndroidHardwareBufferANDROID(decontext->vkdevice,      \
                                                     __VA_ARGS__)
#endif
#ifdef VK_USE_PLATFORM_FUCHSIA
...
#define VKGetMemoryZirconHandleFUCHSIA(...)                                    \
  decontext->vkGetMemoryZirconHandleFUCHSIA(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetMemoryZirconHandlePropertiesFUCHSIA(...)                          \
  decontext->vkGetMemoryZirconHandlePropertiesFUCHSIA(decontext->vkdevice,     \
                                                      __VA_ARGS__)
#endif
#ifdef VK_USE_PLATFORM_FUCHSIA
...
#define VKImportSemaphoreZirconHandleFUCHSIA(...)                              \
  decontext->vkImportSemaphoreZirconHandleFUCHSIA(decontext->vkdevice,         \
                                                  __VA_ARGS__)
...
#define VKGetSemaphoreZirconHandleFUCHSIA(...)                                 \
  decontext->vkGetSemaphoreZirconHandleFUCHSIA(decontext->vkdevice, __VA_ARGS__)
#endif
#ifdef VK_USE_PLATFORM_FUCHSIA
...
#define VKCreateBufferCollectionFUCHSIA(...)                                   \
  decontext->vkCreateBufferCollectionFUCHSIA(decontext->vkdevice, __VA_ARGS__)
...
#define VKSetBufferCollectionImageConstraintsFUCHSIA(...)                      \
  decontext->vkSetBufferCollectionImageConstraintsFUCHSIA(decontext->vkdevice, \
                                                          __VA_ARGS__)
...
#define VKDestroyBufferCollectionFUCHSIA(...)                                  \
  decontext->vkDestroyBufferCollectionFUCHSIA(decontext->vkdevice, __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkGetBufferCollectionPropertiesFUCHSIA(
// VkDevice device, VkBufferCollectionFUCHSIA collection,
// VkBufferCollectionPropertiesFUCHSIA* pProperties);
#define VKGetBufferCollectionPropertiesFUCHSIA(...)                            \
  decontext->vkGetBufferCollectionPropertiesFUCHSIA(decontext->vkdevice,       \
                                                    __VA_ARGS__)
#endif
#ifdef VK_USE_PLATFORM_WIN32_KHR
...
#define VKGetMemoryWin32HandleKHR(...)                                         \
  decontext->vkGetMemoryWin32HandleKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetMemoryWin32HandlePropertiesKHR(...)                               \
  decontext->vkGetMemoryWin32HandlePropertiesKHR(decontext->vkdevice,          \
                                                 __VA_ARGS__)
#endif
#ifdef VK_USE_PLATFORM_WIN32_KHR
...
#define VKImportSemaphoreWin32HandleKHR(...)                                   \
  decontext->vkImportSemaphoreWin32HandleKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetSemaphoreWin32HandleKHR(...)                                      \
  decontext->vkGetSemaphoreWin32HandleKHR(decontext->vkdevice, __VA_ARGS__)
#endif
#ifdef VK_USE_PLATFORM_WIN32_KHR
// VKAPI_ATTR VkResult VKAPI_CALL vkImportFenceWin32HandleKHR( VkDevice device,
// const VkImportFenceWin32HandleInfoKHR* pImportFenceWin32HandleInfo);
#define VKImportFenceWin32HandleKHR(...)                                       \
  decontext->vkImportFenceWin32HandleKHR(decontext->vkdevice, __VA_ARGS__)
...
#define VKGetFenceWin32HandleKHR(...)                                          \
  decontext->vkGetFenceWin32HandleKHR(decontext->vkdevice, __VA_ARGS__)
#endif
#ifdef VK_USE_PLATFORM_WIN32_KHR
...
// pHandle);
#define VKGetMemoryWin32HandleNV(...)                                          \
  decontext->vkGetMemoryWin32HandleNV(decontext->vkdevice, __VA_ARGS__)
#endif
#ifdef VK_USE_PLATFORM_WIN32_KHR
...
#define VKAcquireFullScreenExclusiveModeEXT(...)                               \
  decontext->vkAcquireFullScreenExclusiveModeEXT(decontext->vkdevice,          \
                                                 __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkReleaseFullScreenExclusiveModeEXT( VkDevice
// device, VkSwapchainKHR swapchain);
#define VKReleaseFullScreenExclusiveModeEXT(...)                               \
  decontext->vkReleaseFullScreenExclusiveModeEXT(decontext->vkdevice,          \
                                                 __VA_ARGS__)
...
#define VKGetDeviceGroupSurfacePresentModes2EXT(...)                           \
  decontext->vkGetDeviceGroupSurfacePresentModes2EXT(decontext->vkdevice,      \
                                                     __VA_ARGS__)
#endif
#ifdef VK_USE_PLATFORM_METAL_EXT
// VKAPI_ATTR void VKAPI_CALL vkExportMetalObjectsEXT( VkDevice device,
// VkExportMetalObjectsInfoEXT* pMetalObjectsInfo);
#define VKExportMetalObjectsEXT(...)                                           \
  decontext->vkExportMetalObjectsEXT(decontext->vkdevice, __VA_ARGS__)
#endif
#ifdef VK_USE_PLATFORM_SCREEN_QNX
...
// pProperties);
#define VKGetScreenBufferPropertiesQNX(...)                                    \
  decontext->vkGetScreenBufferPropertiesQNX(decontext->vkdevice, __VA_ARGS__)
#endif
...
#define VKCreateExecutionGraphPipelinesAMDX(...)                               \
  decontext->vkCreateExecutionGraphPipelinesAMDX(decontext->vkdevice,          \
                                                 __VA_ARGS__)
// VKAPI_ATTR VkResult VKAPI_CALL vkGetExecutionGraphPipelineScratchSizeAMDX(
// VkDevice device, VkPipeline executionGraph,
// VkExecutionGraphPipelineScratchSizeAMDX* pSizeInfo);
#define VKGetExecutionGraphPipelineScratchSizeAMDX(...)                        \
  decontext->vkGetExecutionGraphPipelineScratchSizeAMDX(decontext->vkdevice,   \
                                                        __VA_ARGS__)
...
#define VKGetExecutionGraphPipelineNodeIndexAMDX(...)                          \
  decontext->vkGetExecutionGraphPipelineNodeIndexAMDX(decontext->vkdevice,     \
                                                      __VA_ARGS__)
